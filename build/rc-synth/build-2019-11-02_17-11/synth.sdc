...
create_clock -name clk_input -period 100000 [ get_ports "CLK" ]
set_input_delay 100 -clock clk_input [get_ports "RST_N a_in b_in write start"]
set_output_delay 100 -clock clk_input [get_ports "s_out ready"] 
