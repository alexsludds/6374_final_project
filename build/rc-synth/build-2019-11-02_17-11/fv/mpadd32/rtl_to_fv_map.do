...
# Generated on: Sat Nov 02 17:12:15 EDT 2019 (Sat Nov 02 21:12:15 GMT 2019)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/mpadd32/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mpadd32 -revised fv_map
...
elaborate_design -golden -root {mpadd32} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mpadd32/fv_map.v.gz
elaborate_design -revised -root {mpadd32}
...
#add_name_alias fv/mpadd32/fv_map.singlebit.original_name.alias.json.gz -revised
