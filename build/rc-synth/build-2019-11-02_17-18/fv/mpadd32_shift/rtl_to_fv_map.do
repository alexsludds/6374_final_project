...
# Generated on: Sat Nov 02 17:19:34 EDT 2019 (Sat Nov 02 21:19:34 GMT 2019)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/mpadd32_shift/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mpadd32_shift -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/mit/cadence/GENUS/191/tools"
set CDN_SYNTH_ROOT      "/mit/cadence/GENUS/191/tools"
set env(CW_DIR) "/mit/cadence/GENUS/191/tools/lib/chipware"
set CW_DIR      "/mit/cadence/GENUS/191/tools/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path . /mit/cadence/GENUS/191/tools/lib/tech -library -both
read_library -liberty -both /mit/cadence/GPDK045/gsclib045_svt_v4.4/gsclib045/timing/slow_vdd1v2_basicCells.lib
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../../../src/mpadd.v
elaborate_design -golden -root {mpadd32_shift} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mpadd32_shift/fv_map.v.gz
elaborate_design -revised -root {mpadd32_shift}
...
#add_name_alias fv/mpadd32_shift/fv_map.singlebit.original_name.alias.json.gz -revised
